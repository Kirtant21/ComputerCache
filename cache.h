...
class Cache{
    ...
    ******************************************/
    bool m_hashing; // checks if hashing or not
    float oldDeletedRatioHelper() const; // helps delete old ratio
    void createCurrHashHelper(); // helps cearting curr Hash
    void createOldHashHelper(); // helps creat old hash
    void insertCurrHelper(Person person); // helps insert current
    void insertOldHelper(Person person); // helps insert old
    void rehashOld(); // helps rehashing old
    void rehashCurrent(); // helps rehashing curr
    Person* getOldTable(){return m_oldTable;}
